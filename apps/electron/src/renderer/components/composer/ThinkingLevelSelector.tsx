...
const DEFAULT_OPTIONS: LevelOption[] = [
  ...
  },
  {
    ...
    buttonClassName: 'bg-[hsl(var(--brand-soft))] text-[hsl(var(--brand-soft-foreground))] hover:bg-[hsl(var(--brand-soft-hover))]',
    badgeClassName: 'text-[hsl(var(--brand-soft-foreground))]',
  },
  {
    value: 'high',
    label: 'high',
    ...
    buttonClassName: 'bg-[hsl(var(--brand-soft-hover))] text-[hsl(var(--brand-soft-foreground))] hover:bg-[hsl(var(--brand-strong)/0.22)] hover:text-foreground',
    badgeClassName: 'text-[hsl(var(--brand-soft-foreground))]',
  },
  {
    value: 'xhigh',
