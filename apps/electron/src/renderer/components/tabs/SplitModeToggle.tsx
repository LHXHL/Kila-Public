        ...
        <TooltipTrigger asChild>
          <PopoverTrigger asChild>
            <Button
              variant="ghost"
              size="icon"
              className="size-8 shrink-0 rounded-lg border border-border/55 bg-card/75 text-muted-foreground/72 hover:bg-kila-accent-muted hover:text-primary titlebar-no-drag"
            >
