...
/** 卡片容器样式 — 无阴影，细边框 */
export const CARD_CLASS = 'surface-panel overflow-hidden'

/** 卡片内行样式 — 加大留白 */
export const ROW_CLASS = 'flex items-center justify-between px-5 py-4'

/** 卡片内分隔线样式 — 更柔和 */
export const DIVIDER_CLASS = 'border-border/30'
