...
import type { ToolDefinition, ToolParameterProperty } from '@kila/core'
import type { AgentToolInfo, AgentToolMeta } from '@kila/shared'
 ...
 */
export function getAllToolInfos(): AgentToolInfo[] {
  const config = getAgentToolsConfig()
