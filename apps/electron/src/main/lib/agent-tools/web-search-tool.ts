 ...
 * 凭据存储在 ~/.kila/agent-tools.json 的 toolCredentials 中。
 */

import type { ToolCall, ToolResult, ToolDefinition } from '@kila/core'
import type { AgentToolMeta } from '@kila/shared'
import { getToolCredentials } from '../agent-tool-config'
