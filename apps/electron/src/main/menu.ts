...
import { openSettingsWindow } from './lib/settings-window-manager'
      ...
      ? [
          {
            label: 'Kila',
            submenu: [
              { role: 'about' as const, label: '关于 Kila' },
              ...
              { type: 'separator' as const },
              { role: 'hide' as const, label: '隐藏 Kila' },
              { role: 'hideOthers' as const, label: '隐藏其他' },
              { role: 'unhide' as const, label: '显示全部' },
              { type: 'separator' as const },
              { role: 'quit' as const, label: '退出 Kila' },
            ],
          },
        ]
      : []),
      ...
      submenu: [
        {
          label: '了解更多',
          click: async () => {
            await shell.openExternal('https://github.com/yourusername/kila')
          },
        },
      ],
    },
