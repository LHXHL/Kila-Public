/**
 * @deprecated 使用 useSmoothStreamContent 替代
 *
 * useSmoothStream - 流式文本平滑渲染 Hook（旧版）
 *
 * 此 hook 已弃用，内部转发到 useSmoothStreamContent。
 * 保留此文件仅为向后兼容。新代码请直接使用 useSmoothStreamContent。
 *
 * 原始参考：Cherry Studio 的 useSmoothStream 实现。
 */
